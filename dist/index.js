...
(() => {
  ...
  // output/FFI.Clipboard/foreign.js
  var copyToClipboard = (text6) => () => {
    navigator.clipboard.writeText(text6);
  };

  // output/FFI.Wallet/foreign.js
  var detectWallets = () => {
  ...
  var enableWalletByKeyImpl = (key) => (onError) => (onSuccess) => () => {
    const w = window.cardano[key];
    if (!w) {
      onError(new Error("Wallet not found: " + key))();
      return;
    }
    w.enable().then((api) => onSuccess(api)()).catch((err) => onError(new Error(String(err)))());
  };
  var signTxImpl = (api) => (cborHex) => (onError) => (onSuccess) => () => {
    api.signTx(cborHex, true).then((witness) => onSuccess(witness)()).catch((err) => onError(new Error(String(err)))());
  };
  var getNetworkIdImpl = (api) => (onError) => (onSuccess) => () => {
    api.getNetworkId().then((id2) => onSuccess(id2)()).catch((err) => onError(new Error(String(err)))());
  };
  var getBalanceImpl = (api) => (onError) => (onSuccess) => () => {
    api.getBalance().then((bal) => onSuccess(bal)()).catch((err) => onError(new Error(String(err)))());
  };
  var getUtxosImpl = (api) => (onError) => (onSuccess) => () => {
    api.getUtxos().then((utxos) => onSuccess(utxos || [])()).catch((err) => onError(new Error(String(err)))());
  };
  var getUsedAddressesImpl = (api) => (onError) => (onSuccess) => () => {
    api.getUsedAddresses().then((addrs) => onSuccess(addrs || [])()).catch((err) => onError(new Error(String(err)))());
  };
  var getUnusedAddressesImpl = (api) => (onError) => (onSuccess) => () => {
    api.getUnusedAddresses().then((addrs) => onSuccess(addrs || [])()).catch((err) => onError(new Error(String(err)))());
  };
  var getChangeAddressImpl = (api) => (onError) => (onSuccess) => () => {
    api.getChangeAddress().then((addr) => onSuccess(addr)()).catch((err) => onError(new Error(String(err)))());
  };
  var getRewardAddressesImpl = (api) => (onError) => (onSuccess) => () => {
    api.getRewardAddresses().then((addrs) => onSuccess(addrs || [])()).catch((err) => onError(new Error(String(err)))());
  };
  var signDataImpl = (api) => (addr) => (payload) => (onError) => (onSuccess) => () => {
    api.signData(addr, payload).then((sig) => onSuccess(JSON.stringify(sig))()).catch((err) => onError(new Error(String(err)))());
  };
  var submitTxImpl = (api) => (cborHex) => (onError) => (onSuccess) => () => {
    api.submitTx(cborHex).then((hash2) => onSuccess(hash2)()).catch((err) => onError(new Error(String(err)))());
  };

  // output/FFI.Wallet/index.js
  var mempty2 = /* @__PURE__ */ mempty(monoidCanceler);
  var submitTx = function(api) {
    return function(cbor) {
      return makeAff(function(cb) {
        return function __do2() {
          submitTxImpl(api)(cbor)(function(err) {
            return cb(new Left(err));
          })(function(h) {
            return cb(new Right(h));
          })();
          return mempty2;
        };
      });
  ...
  var signTx = function(api) {
    return function(cbor) {
      return makeAff(function(cb) {
        return function __do2() {
          signTxImpl(api)(cbor)(function(err) {
            return cb(new Left(err));
          })(function(wit) {
            return cb(new Right(wit));
          })();
          return mempty2;
        };
      });
  ...
  var signData = function(api) {
    return function(addr) {
      return function(payload) {
        return makeAff(function(cb) {
          return function __do2() {
            signDataImpl(api)(addr)(payload)(function(err) {
              return cb(new Left(err));
            })(function(sig) {
              return cb(new Right(sig));
            })();
            return mempty2;
          };
        });
  ...
  var getUtxos = function(api) {
    return makeAff(function(cb) {
      return function __do2() {
        getUtxosImpl(api)(function(err) {
          return cb(new Left(err));
        })(function(us) {
          return cb(new Right(us));
        })();
        return mempty2;
      };
    });
  ...
  var getUsedAddresses = function(api) {
    return makeAff(function(cb) {
      return function __do2() {
        getUsedAddressesImpl(api)(function(err) {
          return cb(new Left(err));
        })(function(as) {
          return cb(new Right(as));
        })();
        return mempty2;
      };
    });
  ...
  var getUnusedAddresses = function(api) {
    return makeAff(function(cb) {
      return function __do2() {
        getUnusedAddressesImpl(api)(function(err) {
          return cb(new Left(err));
        })(function(as) {
          return cb(new Right(as));
        })();
  ...
  var getRewardAddresses = function(api) {
    return makeAff(function(cb) {
      return function __do2() {
        getRewardAddressesImpl(api)(function(err) {
          return cb(new Left(err));
        })(function(as) {
          return cb(new Right(as));
        })();
  ...
  var getNetworkId = function(api) {
    return makeAff(function(cb) {
      return function __do2() {
        getNetworkIdImpl(api)(function(err) {
          return cb(new Left(err));
        })(function(nid) {
          return cb(new Right(nid));
        })();
        return mempty2;
      };
    });
  ...
  var getChangeAddress = function(api) {
    return makeAff(function(cb) {
      return function __do2() {
        getChangeAddressImpl(api)(function(err) {
          return cb(new Left(err));
        })(function(a2) {
          return cb(new Right(a2));
        })();
        return mempty2;
      };
    });
  ...
  var getBalance = function(api) {
    return makeAff(function(cb) {
      return function __do2() {
        getBalanceImpl(api)(function(err) {
          return cb(new Left(err));
        })(function(bal) {
          return cb(new Right(bal));
        })();
        return mempty2;
      };
    });
  };
  var enableWalletByKey = function(key) {
    return makeAff(function(cb) {
      return function __do2() {
        enableWalletByKeyImpl(key)(function(err) {
          return cb(new Left(err));
        })(function(api) {
          return cb(new Right(api));
        })();
        return mempty2;
      };
    });
  ...
  var PollWallets = /* @__PURE__ */ (function() {
    function PollWallets2(value0) {
      this.value0 = value0;
    }
    ;
    PollWallets2.create = function(value0) {
      return new PollWallets2(value0);
    };
    return PollWallets2;
  })();
  ...
  var SetTxCbor = /* @__PURE__ */ (function() {
    function SetTxCbor2(value0) {
      this.value0 = value0;
    }
    ;
    SetTxCbor2.create = function(value0) {
      return new SetTxCbor2(value0);
    };
    return SetTxCbor2;
  })();
  var SignTx = /* @__PURE__ */ (function() {
    ...
    ;
    SignTx2.value = new SignTx2();
    return SignTx2;
  })();
  var CopyWitness = /* @__PURE__ */ (function() {
    function CopyWitness2() {
    }
    ;
    CopyWitness2.value = new CopyWitness2();
    return CopyWitness2;
  })();
  var SetSignDataAddr = /* @__PURE__ */ (function() {
    function SetSignDataAddr2(value0) {
      this.value0 = value0;
    }
    ;
    SetSignDataAddr2.create = function(value0) {
      return new SetSignDataAddr2(value0);
    };
    return SetSignDataAddr2;
  })();
  var SetSignDataPayload = /* @__PURE__ */ (function() {
    function SetSignDataPayload2(value0) {
      this.value0 = value0;
    }
    ;
    SetSignDataPayload2.create = function(value0) {
      return new SetSignDataPayload2(value0);
    };
    return SetSignDataPayload2;
  })();
  var DoSignData = /* @__PURE__ */ (function() {
    function DoSignData2() {
    }
    ;
    DoSignData2.value = new DoSignData2();
    return DoSignData2;
  })();
  var CopySignData = /* @__PURE__ */ (function() {
    function CopySignData2() {
    }
    ;
    CopySignData2.value = new CopySignData2();
    return CopySignData2;
  })();
  var SetSubmitCbor = /* @__PURE__ */ (function() {
    function SetSubmitCbor2(value0) {
      this.value0 = value0;
    }
    ;
    SetSubmitCbor2.create = function(value0) {
      return new SetSubmitCbor2(value0);
    };
    return SetSubmitCbor2;
  })();
  var DoSubmitTx = /* @__PURE__ */ (function() {
    function DoSubmitTx2() {
    }
    ;
    DoSubmitTx2.value = new DoSubmitTx2();
    return DoSubmitTx2;
  })();
  var ToggleWalletInfo = /* @__PURE__ */ (function() {
    function ToggleWalletInfo2() {
    }
    ;
    ToggleWalletInfo2.value = new ToggleWalletInfo2();
    return ToggleWalletInfo2;
  })();
  var renderWalletBtn = function(w) {
    return button([class_("wallet-btn"), onClick(function(v) {
      return new ConnectWallet(w.key);
    })])([(function() {
      var $69 = length3(w.icon) > 0;
      if ($69) {
        return img([src9(w.icon), class_("wallet-icon")]);
      }
      ;
      return text5("");
    })(), text5(w.name)]);
  };
  var renderWalletStatus = function(state3) {
    if (isJust(state3.walletApi)) {
      return div2([class_("wallet-status")])([span3([class_("dot connected")])([]), text5((function() {
        if (state3.connectedName instanceof Just) {
          return state3.connectedName.value0 + " connected";
        }
        ;
        if (state3.connectedName instanceof Nothing) {
          return "Connected";
        }
        ;
    ...
    ;
    if (!$$null(state3.availableWallets)) {
      return div2([class_("wallet-picker")])([label_([text5("Select wallet")]), div2([class_("wallet-list")])(map20(renderWalletBtn)(state3.availableWallets))]);
    }
    ;
    if (otherwise) {
  ...
  var renderSubmitCard = function(state3) {
    ...
    return div2([class_("card")])([label_([text5("Submit Transaction")]), textarea([placeholder3("Paste fully-signed transaction CBOR hex..."), value13(state3.submitCbor), onValueInput(SetSubmitCbor.create)]), div2([class_("actions")])([button([class_("btn-primary"), disabled10(!canSubmit), onClick(function(v) {
      return DoSubmitTx.value;
    })])([text5("Submit Transaction")])]), (function() {
      if (state3.submitResult instanceof Nothing) {
        return text5("");
      }
      ;
      if (state3.submitResult instanceof Just) {
  ...
  var renderSignDataResult = function(state3) {
    if (state3.signDataResult instanceof Nothing) {
      return div2([class_("result-area")])([]);
    }
    ;
    if (state3.signDataResult instanceof Just) {
      return div2([class_("result-area show")])([div2([class_("card")])([label_([text5("Data Signature")]), textarea([value13(state3.signDataResult.value0), readOnly3(true)]), div2([class_("actions")])([button([class_("btn-secondary"), onClick(function(v) {
        return CopySignData.value;
      })])([text5("Copy to Clipboard")])]), (function() {
        if (state3.copySignDataHint) {
          return div2([class_("copy-hint")])([text5("Copied!")]);
        }
        ;
        return text5("");
      })()])]);
  ...
  var renderSignDataCard = function(state3) {
    ...
    return div2([class_("card")])([label_([text5("Sign Data (CIP-8)")]), label_([text5("Address (hex)")]), textarea([placeholder3("Address hex for signing..."), value13(state3.signDataAddr), onValueInput(SetSignDataAddr.create), class_("textarea-small")]), label_([text5("Payload (hex)")]), textarea([placeholder3("Hex-encoded payload to sign..."), value13(state3.signDataPayload), onValueInput(SetSignDataPayload.create), class_("textarea-small")]), div2([class_("actions")])([button([class_("btn-primary"), disabled10(!canSignData), onClick(function(v) {
      return DoSignData.value;
    })])([text5("Sign Data")])])]);
  };
  var renderResult = function(state3) {
    if (state3.witness instanceof Nothing) {
      return div2([class_("result-area")])([]);
    }
    ;
    if (state3.witness instanceof Just) {
      return div2([class_("result-area show")])([div2([class_("card")])([label_([text5("Witness")]), textarea([value13(state3.witness.value0), readOnly3(true)]), div2([class_("actions")])([button([class_("btn-secondary"), onClick(function(v) {
        return CopyWitness.value;
      })])([text5("Copy to Clipboard")])]), (function() {
        if (state3.copyHint) {
          return div2([class_("copy-hint")])([text5("Copied!")]);
        }
  ...
  var renderCard = function(state3) {
    ...
    return div2([class_("card")])([label_([text5("Transaction CBOR")]), textarea([placeholder3("Paste transaction CBOR hex..."), value13(state3.txCbor), onValueInput(SetTxCbor.create)]), div2([class_("actions")])([button([class_("btn-primary"), disabled10(!canSign), onClick(function(v) {
      return SignTx.value;
    })])([text5("Sign Transaction")])])]);
  };
  var renderAddressList = function(label5) {
    return function(addrs) {
      var renderAddr = function(addr) {
        return div2([class_("address-item")])([text5(addr)]);
      };
      var $81 = length(addrs) === 0;
      if ($81) {
        return text5("");
      }
      ;
      return div2([class_("address-list")])([label_([text5(label5)]), div_(map20(renderAddr)(addrs))]);
    };
  };
  var networkName = function(v) {
    if (v === 0) {
      return "Testnet";
    }
    ;
    ...
    ;
    return "Unknown (" + (show2(v) + ")");
  };
  var kindClass = function(v) {
  ...
  var renderStatus = function(state3) {
    if (state3.status instanceof Nothing) {
      return div2([class_("status")])([]);
    }
    ;
    if (state3.status instanceof Just) {
  ...
  var initialState = function(v) {
    return {
      availableWallets: [],
      connectedName: Nothing.value,
      walletApi: Nothing.value,
      walletInfo: Nothing.value,
      walletInfoOpen: false,
      txCbor: "",
      status: Nothing.value,
      witness: Nothing.value,
      copyHint: false,
      signDataAddr: "",
      signDataPayload: "",
      signDataResult: Nothing.value,
      copySignDataHint: false,
      submitCbor: "",
      submitResult: Nothing.value
    };
  };
  var infoRow = function(label5) {
    return function(value1) {
      return div2([class_("info-row")])([span3([class_("info-label")])([text5(label5)]), span3([class_("info-value")])([text5(value1)])]);
    };
  };
  var renderWalletInfo = function(state3) {
    var bodyClass = (function() {
      if (state3.walletInfoOpen) {
        return " open";
      }
      ;
      return "";
    ...
    if (state3.walletInfo instanceof Nothing) {
      return div2([class_("wallet-info")])([]);
    }
    ;
    if (state3.walletInfo instanceof Just) {
      return div2([class_("wallet-info show")])([div2([class_("card")])([div2([class_("section-toggle"), onClick(function(v) {
        return ToggleWalletInfo.value;
  ...
  var findName = function(key) {
    return function(wallets) {
      return fromMaybe(key)(map110(function(v) {
        return v.name;
      })(head(filter(function(w) {
        return w.key === key;
      })(wallets))));
    };
  };
  var fetchWalletInfo = function(dictMonadAff) {
    var liftAff2 = liftAff(monadAffHalogenM(dictMonadAff));
    return function(api) {
      return bind5(liftAff2(attempt(bind15(getNetworkId(api))(function(nid) {
        return bind15(getBalance(api))(function(bal) {
          return bind15(getUtxos(api))(function(utxos) {
            return bind15(getUsedAddresses(api))(function(used) {
              return bind15(getUnusedAddresses(api))(function(unused) {
                return bind15(getChangeAddress(api))(function(change2) {
                  return bind15(getRewardAddresses(api))(function(reward) {
                    return pure9({
                      networkId: nid,
                      balance: bal,
        ...
        if (result instanceof Right) {
          return modify_3(function(v) {
            ...
            ;
            $92.walletInfo = new Just(result.value0);
            $92.status = Nothing.value;
            return $92;
          });
        }
        ;
        if (result instanceof Left) {
          return modify_3(function(v) {
            ...
            $96.status = new Just({
              kind: $$Error.value,
              text: "Failed to load wallet info: " + show1(result.value0)
            });
            return $96;
          });
        }
  ...
  var handleAction = function(dictMonadAff) {
    ...
    var liftAff2 = liftAff(monadAffHalogenM(dictMonadAff));
    var fetchWalletInfo1 = fetchWalletInfo(dictMonadAff);
    return function(v) {
      if (v instanceof Initialize2) {
        return handleAction(dictMonadAff)(new PollWallets(20));
      }
      ;
      if (v instanceof PollWallets) {
        return bind5(liftEffect7(detectWallets))(function(wallets) {
          var $101 = !$$null(wallets);
          if ($101) {
            return modify_3(function(v1) {
              ...
              ;
              $102.availableWallets = wallets;
              return $102;
            });
          }
          ;
          return when4(v.value0 > 0)(discard5(liftAff2(delay(500)))(function() {
            return handleAction(dictMonadAff)(new PollWallets(v.value0 - 1 | 0));
          }));
        });
      }
      ;
      if (v instanceof ConnectWallet) {
        return discard5(modify_3(function(v1) {
          ...
          return bind5(liftAff2(attempt(enableWalletByKey(v.value0))))(function(result) {
            if (result instanceof Right) {
              return bind5(get2)(function(st) {
                var name15 = findName(v.value0)(st.availableWallets);
                return discard5(modify_3(function(v1) {
                  var $110 = {};
                  for (var $111 in v1) {
                  ...
                  ;
                  $110.walletApi = new Just(result.value0);
                  $110.connectedName = new Just(name15);
                  $110.status = new Just({
                    kind: Info.value,
                  ...
                  return fetchWalletInfo1(result.value0);
                });
              });
            }
            ;
            if (result instanceof Left) {
              return modify_3(function(v1) {
                ...
                $114.status = new Just({
                  kind: $$Error.value,
                  text: "Connection failed: " + show1(result.value0)
                });
                return $114;
              });
            }
      ...
      ;
      if (v instanceof SignTx) {
        return bind5(get2)(function(st) {
          if (st.walletApi instanceof Nothing) {
            return pure13(unit);
          }
          ;
          if (st.walletApi instanceof Just) {
            var cbor = trim(st.txCbor);
            return when4(length3(cbor) > 0)(discard5(modify_3(function(v1) {
              var $124 = {};
              for (var $125 in v1) {
              ...
              $124.witness = Nothing.value;
              return $124;
            }))(function() {
              return bind5(liftAff2(attempt(signTx(st.walletApi.value0)(cbor))))(function(result) {
                if (result instanceof Right) {
                  return modify_3(function(v1) {
                    var $128 = {};
                    for (var $129 in v1) {
                    ...
                    ;
                    $128.witness = new Just(result.value0);
                    $128.status = new Just({
                      kind: Success.value,
                ...
                if (result instanceof Left) {
                  return modify_3(function(v1) {
                    ...
                    $132.status = new Just({
                      kind: $$Error.value,
                      text: "Signing failed: " + show1(result.value0)
                    });
                    return $132;
                  });
                }
      ...
      ;
      if (v instanceof CopyWitness) {
        return bind5(get2)(function(st) {
          if (st.witness instanceof Nothing) {
            return pure13(unit);
          }
          ;
          if (st.witness instanceof Just) {
            return discard5(liftEffect7(copyToClipboard(st.witness.value0)))(function() {
              return discard5(modify_3(function(v1) {
                var $138 = {};
                for (var $139 in v1) {
                ...
                return discard5(liftAff2(delay(2e3)))(function() {
                  return modify_3(function(v1) {
                    var $141 = {};
                    for (var $142 in v1) {
      ...
      ;
      if (v instanceof SetSignDataAddr) {
        return modify_3(function(v1) {
          var $145 = {};
          for (var $146 in v1) {
          ...
          ;
          $145.signDataAddr = v.value0;
          return $145;
        });
      }
      ;
      if (v instanceof SetSignDataPayload) {
        return modify_3(function(v1) {
          var $149 = {};
          for (var $150 in v1) {
          ...
          ;
          $149.signDataPayload = v.value0;
          return $149;
        });
      }
      ;
      if (v instanceof DoSignData) {
        return bind5(get2)(function(st) {
          if (st.walletApi instanceof Nothing) {
            return pure13(unit);
          }
          ;
          if (st.walletApi instanceof Just) {
            var payload = trim(st.signDataPayload);
            var addr = trim(st.signDataAddr);
            return when4(length3(addr) > 0 && length3(payload) > 0)(discard5(modify_3(function(v1) {
              var $154 = {};
              for (var $155 in v1) {
              ...
              $154.signDataResult = Nothing.value;
              return $154;
            }))(function() {
              return bind5(liftAff2(attempt(signData(st.walletApi.value0)(addr)(payload))))(function(result) {
                if (result instanceof Right) {
                  return modify_3(function(v1) {
                    var $158 = {};
                    for (var $159 in v1) {
                    ...
                    ;
                    $158.signDataResult = new Just(result.value0);
                    $158.status = new Just({
                      kind: Success.value,
                      text: "Data signed"
                    });
                ...
                if (result instanceof Left) {
                  return modify_3(function(v1) {
                    ...
                    $162.status = new Just({
                      kind: $$Error.value,
                      text: "Sign data failed: " + show1(result.value0)
                    });
                    return $162;
                  });
                }
      ...
      ;
      if (v instanceof CopySignData) {
        return bind5(get2)(function(st) {
          if (st.signDataResult instanceof Nothing) {
            return pure13(unit);
          }
          ;
          if (st.signDataResult instanceof Just) {
            return discard5(liftEffect7(copyToClipboard(st.signDataResult.value0)))(function() {
              return discard5(modify_3(function(v1) {
                var $168 = {};
                for (var $169 in v1) {
      ...
      if (v instanceof SetSubmitCbor) {
        return modify_3(function(v1) {
          ...
          ;
          $175.submitCbor = v.value0;
          return $175;
        });
      }
      ;
      if (v instanceof DoSubmitTx) {
        return bind5(get2)(function(st) {
          if (st.walletApi instanceof Nothing) {
            return pure13(unit);
          }
          ...
          if (st.walletApi instanceof Just) {
            ...
            return when4(length3(cbor) > 0)(discard5(modify_3(function(v1) {
              ...
              $180.submitResult = Nothing.value;
              return $180;
            }))(function() {
              return bind5(liftAff2(attempt(submitTx(st.walletApi.value0)(cbor))))(function(result) {
                if (result instanceof Right) {
                  return modify_3(function(v1) {
                    var $184 = {};
                    for (var $185 in v1) {
                    ...
                    ;
                    $184.submitResult = new Just(result.value0);
                    $184.status = new Just({
                      kind: Success.value,
                ...
                if (result instanceof Left) {
                  return modify_3(function(v1) {
                    ...
                    $188.status = new Just({
                      kind: $$Error.value,
                      text: "Submit failed: " + show1(result.value0)
                    });
                    return $188;
                  });
                }
      ...
      ;
      if (v instanceof ToggleWalletInfo) {
        return modify_3(function(s) {
          ...
          ;
          $193.walletInfoOpen = !s.walletInfoOpen;
          return $193;
        });
      }
      ;
